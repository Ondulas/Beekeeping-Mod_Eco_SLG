...
// Type: Eco.Mods.TechTree.WaxedWoodenTableLampObject
...
namespace Eco.Mods.TechTree
{
  ...
  public class WaxedWoodenTableLampObject : WorldObject, IRepresentsItem
  {
    ...
    public virtual Type RepresentedItemType
    {
      get
      {
        return typeof (WaxedWoodenTableLampItem);
      }
    }

    protected override void Initialize()
    {
      this.GetComponent<PowerConsumptionComponent>((string) null).Initialize(60f);
      this.GetComponent<PowerGridComponent>((string) null).Initialize(10f, (IPowerEnergyType) new ElectricPower());
      this.GetComponent<HousingComponent>((string) null).HomeValue = WaxedWoodenTableLampItem.HomeValue;
    }
