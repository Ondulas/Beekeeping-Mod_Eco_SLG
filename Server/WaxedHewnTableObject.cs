...
// Type: Eco.Mods.TechTree.WaxedHewnTableObject
...
namespace Eco.Mods.TechTree
{
  ...
  public class WaxedHewnTableObject : WorldObject, IRepresentsItem
  {
    ...
    public virtual Type RepresentedItemType
    {
      get
      {
        return typeof (WaxedHewnTableItem);
      }
    }

    protected override void Initialize()
    {
      this.GetComponent<HousingComponent>((string) null).HomeValue = WaxedHewnTableItem.HomeValue;
    }
