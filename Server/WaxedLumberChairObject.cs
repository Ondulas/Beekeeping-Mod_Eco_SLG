...
// Type: Eco.Mods.TechTree.WaxedLumberChairObject
...
namespace Eco.Mods.TechTree
{
  ...
  public class WaxedLumberChairObject : WorldObject, IRepresentsItem
  {
    ...
    public virtual Type RepresentedItemType
    {
      get
      {
        return typeof (WaxedLumberChairItem);
      }
    }

    protected override void Initialize()
    {
      this.GetComponent<HousingComponent>((string) null).HomeValue = WaxedLumberChairItem.HomeValue;
