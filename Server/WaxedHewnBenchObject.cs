...
// Type: Eco.Mods.TechTree.WaxedHewnBenchObject
...
namespace Eco.Mods.TechTree
{
  ...
  public class WaxedHewnBenchObject : WorldObject, IRepresentsItem
  {
    public override LocString DisplayName
    {
      get
      {
        return Localizer.DoStr("Waxed Hewn Bench");
      }
    }
    ...
    public virtual Type RepresentedItemType
    {
      get
      {
        return typeof (WaxedHewnBenchItem);
      }
    }

    protected override void Initialize()
    {
      this.GetComponent<HousingComponent>((string) null).HomeValue = WaxedHewnBenchItem.HomeValue;
