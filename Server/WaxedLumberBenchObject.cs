...
// Type: Eco.Mods.TechTree.WaxedLumberBenchObject
...
namespace Eco.Mods.TechTree
{
  ...
  public class WaxedLumberBenchObject : WorldObject, IRepresentsItem
  {
    ...
    public virtual Type RepresentedItemType
    {
      get
      {
        return typeof (WaxedLumberBenchItem);
      }
    }

    protected override void Initialize()
    {
      this.GetComponent<HousingComponent>((string) null).HomeValue = WaxedLumberBenchItem.HomeValue;
