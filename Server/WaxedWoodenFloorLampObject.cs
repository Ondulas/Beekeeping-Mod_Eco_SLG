...
// Type: Eco.Mods.TechTree.WaxedWoodenFloorLampObject
...
namespace Eco.Mods.TechTree
{
  ...
  public class WaxedWoodenFloorLampObject : WorldObject, IRepresentsItem
  {
    ...
    public virtual Type RepresentedItemType
    {
      get
      {
        return typeof (WaxedWoodenFloorLampItem);
      }
    }
    ...
    protected override void Initialize()
    {
      ...
      this.GetComponent<HousingComponent>((string) null).HomeValue = WaxedWoodenFloorLampItem.HomeValue;
    }
