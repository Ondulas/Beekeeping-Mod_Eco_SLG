...
// Type: Eco.Mods.TechTree.WaxedBookshelfObject
...
namespace Eco.Mods.TechTree
{
  ...
  public class WaxedBookshelfObject : WorldObject, IRepresentsItem
  {
    ...
    public virtual Type RepresentedItemType
    {
      get
      {
        return typeof (WaxedBookshelfItem);
      }
    }

    protected override void Initialize()
    {
      this.GetComponent<HousingComponent>((string) null).HomeValue = WaxedBookshelfItem.HomeValue;
