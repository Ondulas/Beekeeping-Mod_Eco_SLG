...
// Type: Eco.Mods.TechTree.WaxedSmallTableObject
...
namespace Eco.Mods.TechTree
{
  ...
  public class WaxedSmallTableObject : WorldObject, IRepresentsItem
  {
    ...
    public virtual Type RepresentedItemType
    {
      get
      {
        return typeof (WaxedSmallTableItem);
      }
    }

    protected override void Initialize()
    {
      this.GetComponent<HousingComponent>((string) null).HomeValue = WaxedSmallTableItem.HomeValue;
    }
