...
// Type: Eco.Mods.TechTree.WaxedLumberTableObject
...
namespace Eco.Mods.TechTree
{
  ...
  public class WaxedLumberTableObject : WorldObject, IRepresentsItem
  {
    public override LocString DisplayName
    {
      get
      {
        return Localizer.DoStr("Waxed Lumber Table");
      }
    }
    ...
    public virtual Type RepresentedItemType
    {
      get
      {
        return typeof (WaxedLumberTableItem);
      }
    }

    protected override void Initialize()
    {
      this.GetComponent<HousingComponent>((string) null).HomeValue = WaxedLumberTableItem.HomeValue;
    }
